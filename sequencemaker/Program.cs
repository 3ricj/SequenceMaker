...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        double[] target_sequence = sequence3;
        ...
        const double overheadTime = 1.6; // Overhead time in seconds
        ...
        */
        ...
        Console.WriteLine($"Total time for the sequence: {hours} hours and {minutes} minutes");
...
//                writer.WriteStartElement("Target");
                ...
                writer.WriteAttributeString("AutoFocusOnFilterChange", "true");
                writer.WriteAttributeString("AutoFocusAfterTemperatureChange", "true");
                writer.WriteAttributeString("AutoFocusAfterTemperatureChangeAmount", "5");
//                writer.WriteEndElement();
            }
            else
            {
